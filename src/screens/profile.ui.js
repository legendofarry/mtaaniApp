...
export const renderProfile = async () => {
  ...
  content.innerHTML = `
    <div class="flex flex-col h-full p-4">
      ...
      <button id="logout-btn" class="ml-auto mr-auto my-[30px] w-full max-w-xs py-3 rounded-xl bg-red-600 text-white font-semibold text-base shadow-md active:scale-95 transition">Logout</button>
    </div>
  `;
