    ...
    <div class="flex flex-col h-full p-4">
      ...
      <div class="card rounded-xl p-4 mb-4">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-muted">Estimated Units Left</p>
            <h3 class="text-3xl font-bold text-accent">120 units</h3>
            <p class="text-sm text-muted mt-1">Approx. ${est}</p>
          </div>
        </div>
        <p class="text-xs text-muted mt-3">Next top-up (estimate): ${nextTopup}</p>
      </div>

      <div class="card rounded-xl p-4 mb-4">
        <p class="text-muted mb-2">Token History</p>
